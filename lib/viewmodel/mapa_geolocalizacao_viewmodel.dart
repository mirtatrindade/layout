...
class MapaGeolocalizacaoViewModel extends ChangeNotifier {
  ...
  Future<void> obterMinhaLocalizacao() async {
    ...
    // obtenção da localização atual: import 'package:geolocator/geolocator.dart';
  ...
  Future<void> buscarRota(LatLng origem, LatLng destino) async {
    ...
    // implementar obtenção da rota via OSRM:
